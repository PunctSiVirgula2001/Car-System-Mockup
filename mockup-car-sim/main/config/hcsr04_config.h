...
#define HCSR04_TRIGGER_PERIOD_MS   (30U)    /* Period between sensor triggers in milliseconds */

#define HCSR04_DISTANCE_TO_STOP_CM (20U)   /* Distance threshold in cm to trigger stop/emergency brake */
