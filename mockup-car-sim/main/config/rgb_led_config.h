...
#define GPIO_RGB_BACKWARD_RED    (27U)
#define GPIO_RGB_BACKWARD_GREEN  (26U)
#define GPIO_RGB_BACKWARD_BLUE   (25U)

/* GPIOs used for RGB backward LEDs */
#define GPIO_RGB_FORWARD_RED   (14U)
#define GPIO_RGB_FORWARD_GREEN (12U)
#define GPIO_RGB_FORWARD_BLUE  (13U)
